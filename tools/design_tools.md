...
1. 색상 추출 (Color Extraction)
- 이미지에서 자동 색상 추출
- 주요 색상 팔레트 생성
- 색상 값 자동 복사 (HEX, RGB, HSL)
- 이미지 드래그 앤 드롭 지원
